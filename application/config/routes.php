...
$route['pagination_marketplace'] = 'teemarket/pagination_marketplace';
$route['marketplace/category/(:any)'] = 'teemarket/category/$1';
$route['pagination_category'] = 'teemarket/pagination_category';
$route['marketplace/search/(:any)'] = 'teemarket/search/$1';
$route['pagination_search'] = 'teemarket/pagination_search';
