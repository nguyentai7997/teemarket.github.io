...
<!-- Mirrored from portotheme.com/html/porto_ecommerce/demo_3/product-simple.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Apr 2020 02:57:37 GMT -->
<head>
	<meta charset="UTF-8">
									...
									<div class="product-slider-container product-item">
										<div class="product-single-carousel owl-carousel owl-theme">
											<div class="product-item">
												<img class="product-single-image" src="<?= base_url() ?>global/portraits/mens-crew-front-new.png" style="background-color: <?php echo $colors[0][0]['color_code']; ?>"/>
											</div>
<!--											<div class="product-item">-->
<!--												<img class="product-single-image" src="--><?//= base_url()?><!--assets/images/products/zoom/product-2.jpg" data-zoom-image="--><?//= base_url()?><!--assets/images/products/zoom/product-2-big.jpg"/>-->
<!--											</div>-->
<!--											<div class="product-item">-->
<!--												<img class="product-single-image" src="--><?//= base_url()?><!--assets/images/products/zoom/product-3.jpg" data-zoom-image="--><?//= base_url()?><!--assets/images/products/zoom/product-3-big.jpg"/>-->
<!--											</div>-->
<!--											<div class="product-item">-->
<!--												<img class="product-single-image" src="--><?//= base_url()?><!--assets/images/products/zoom/product-4.jpg" data-zoom-image="--><?//= base_url()?><!--assets/images/products/zoom/product-4-big.jpg"/>-->
<!--											</div>-->
										</div>
									...
									<div class="prod-thumbnail row owl-dots" id='carousel-custom-dots'>
										<div class="col-3 owl-dot">
											<img src="<?= base_url()?>assets/images/products/zoom/product-1.jpg"/>
										</div>
										<div class="col-3 owl-dot">
											<img src="<?= base_url()?>assets/images/products/zoom/product-2.jpg"/>
										</div>
										<div class="col-3 owl-dot">
											<img src="<?= base_url()?>assets/images/products/zoom/product-3.jpg"/>
										</div>
										<div class="col-3 owl-dot">
											<img src="<?= base_url()?>assets/images/products/zoom/product-4.jpg"/>
										</div>
									</div>
									...
									<div class="product-filters-container">
										<div class="product-single-filter">
											...
											<ul class="config-swatch-list">
												...
												<li class="<?php echo $color[$i]['color'] ;?>">
													<a href="#" style="background-color: <?php echo $color[$i]['color_code']; ?>"></a>
												</li>
												<?php }} ?>
											</ul>
					...
					<div class="sidebar-wrapper">
						...
						<div class="widget widget-banner">
							<div class="banner banner-image">
								<a href="#">
									<img src="<?= base_url()?>assets/images/banners/banner-sidebar.jpg" alt="Banner Desc">
								</a>
							</div><!-- End .banner -->
						</div><!-- End .widget -->
								...
								<div class="owl-carousel widget-featured-products">
									<div class="featured-col">
										<div class="product-default left-details product-widget">
											<figure>
												<a href="product.html">
													<img src="<?= base_url()?>assets/images/products/product-7.jpg">
												</a>
											</figure>
											...
											<figure>
												<a href="product.html">
													<img src="<?= base_url()?>assets/images/products/product-8.jpg">
												</a>
											</figure>
											<div class="product-details">
												<h2 class="product-title">
											...
											<figure>
												<a href="product.html">
													<img src="<?= base_url()?>assets/images/products/product-9.jpg">
												</a>
											</figure>
											<div class="product-details">
												<h2 class="product-title">
									...
									<div class="featured-col">
										<div class="product-default left-details product-widget">
											<figure>
												<a href="product.html">
													<img src="<?= base_url()?>assets/images/products/product-10.jpg">
												</a>
											</figure>
											<div class="product-details">
												<h2 class="product-title">
											...
											<figure>
												<a href="product.html">
													<img src="<?= base_url()?>assets/images/products/product-11.jpg">
												</a>
											</figure>
											<div class="product-details">
												<h2 class="product-title">
											...
											<figure>
												<a href="product.html">
													<img src="<?= base_url()?>assets/images/products/product-12.jpg">
												</a>
											</figure>
											<div class="product-details">
												<h2 class="product-title">
