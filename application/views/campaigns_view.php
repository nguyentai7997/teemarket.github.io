...
<!-- Mirrored from getbootstrapadmin.com/remark/material/iconbar/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Apr 2020 15:31:35 GMT -->
<head>
	<meta charset="utf-8">
									...
									<ul class="blocks-3">
										<li>
											<a class="thumbnail m-0" href="javascript:void(0)">
												<img class="w-full" src="<?= base_url()?>global/photos/view-1-150x100.jpg" alt="..." />
											</a>
										</li>
										<li>
											<a class="thumbnail m-0" href="javascript:void(0)">
												<img class="w-full" src="<?= base_url()?>global/photos/view-2-150x100.jpg" alt="..." />
											</a>
										</li>
										<li>
											<a class="thumbnail m-0" href="javascript:void(0)">
												<img class="w-full" src="<?= base_url()?>global/photos/view-3-150x100.jpg" alt="..." />
											</a>
										</li>
										<li>
											<a class="thumbnail m-0" href="javascript:void(0)">
												<img class="w-full" src="<?= base_url()?>global/photos/view-4-150x100.jpg" alt="..." />
											</a>
										</li>
										<li>
											<a class="thumbnail m-0" href="javascript:void(0)">
												<img class="w-full" src="<?= base_url()?>global/photos/view-5-150x100.jpg" alt="..." />
											</a>
										</li>
										<li>
											<a class="thumbnail m-0" href="javascript:void(0)">
												<img class="w-full" src="<?= base_url()?>global/photos/view-6-150x100.jpg" alt="..." />
											</a>
										</li>
									</ul>
								</div>
